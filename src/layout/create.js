...
function Create() {
    ...
    function handleSubmit(event) {
        ...
        axios.post('http://localhost:8081/create', {nama, matkul, dosen})
        .then(res => {
            console.log(res);
            navigate('/');
                ...
                <div className="bg-gray-500 dark:bg-gray-600 p-3 rounded shadow-lg">
                    ...
                    <div>
                        <form onSubmit={handleSubmit}>
                            ...
                            <button className="bg-green-600 dark:bg-green-700 hover:bg-green-800 rounded-lg w-full py-1 px-2">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
